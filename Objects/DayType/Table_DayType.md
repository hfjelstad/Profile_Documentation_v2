...
| Name | String | 1..1 |  | 1..1 | Human-readable name of the day classification | DayType/Name |
...
| HolidayTypes | HolidayTypeEnum |  |  | 0..1 | Holiday classification: `AnyDay`, `WorkingDay`, `SchoolDay`, `NotHoliday`, `AnyHoliday`, `NationalHoliday`, `RegionalHoliday`, `EveOfHoliday`, `HolidayDisplacementDay` | DayType/properties/PropertyOfDay/HolidayTypes |
