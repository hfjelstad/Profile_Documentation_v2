...
| TransportMode | Enum | 1..1 | 1..1 | 1..1 | Primary transport mode (bus, rail, water, tram, metro, air, coach, telecabin) | Line/TransportMode |
...
| [Operator](../Operator/Table_Operator.md)@ref | Reference | 1..1 | 1..1 | 1..1 | Reference to the Operator running this Line | Line/OperatorRef/@ref |
