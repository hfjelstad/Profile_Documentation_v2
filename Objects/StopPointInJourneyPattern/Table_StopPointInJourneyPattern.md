...
|---------|------|-----|-------------|------|
| **@id** | ID | 1..1 | Unique identifier for the assignment | noticeAssignments/NoticeAssignment/@id |
| **@version** | xsd:string | 1..1 | Version label | noticeAssignments/NoticeAssignment/@version |
| **@order** | xsd:integer | 1..1 | Evaluation order | noticeAssignments/NoticeAssignment/@order |
...
| Element | Type | FR | Description | Path |
|---------|------|-----|-------------|------|
| BookingAccess | BookingAccessEnum | 0..1 | Who can book: `public`, `authorisedPublic`, `staff` | BookingArrangements/BookingAccess |
| BookWhen | PurchaseWhenEnum | 0..1 | When to book: `advanceOnly`, `dayOfTravelOnly`, `untilPreviousDay`, `advanceAndDayOfTravel` | BookingArrangements/BookWhen |
| LatestBookingTime | xsd:time | 0..1 | Latest time a booking can be made (e.g., 16:00:00) | BookingArrangements/LatestBookingTime |
| MinimumBookingPeriod | xsd:duration | 0..1 | Minimum advance booking period (e.g., PT2H) | BookingArrangements/MinimumBookingPeriod |
| BookingUrl | xsd:anyURI | | URL for online booking | BookingArrangements/BookingUrl |
| BookingNote | xsd:string | 0..1 | Human-readable booking instructions | BookingArrangements/BookingNote |
| BookingMethod | BookingMethodEnum | 0..n | How to book: `callDriver`, `callOffice`, `online`, `phoneAtStop`, `text` | BookingArrangements/BookingMethods/BookingMethod |
