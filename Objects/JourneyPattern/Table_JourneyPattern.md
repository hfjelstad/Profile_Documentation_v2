...
| [Route](../Route/Table_Route.md)@ref | Reference |  | 1..1 | 1..1 | Reference to the Route this pattern belongs to | JourneyPattern/RouteRef/@ref |
...
| [ScheduledStopPoint](../ScheduledStopPoint/Table_ScheduledStopPoint.md)@ref | Reference |  | 1..1 | 1..1 | Reference to the logical stop point | JourneyPattern/pointsInSequence/StopPointInJourneyPattern/ScheduledStopPointRef/@ref |
...
| ServiceLinkRef/@ref | Reference |  | 1..1 | 1..1 | Reference to a ServiceLink | JourneyPattern/linksInSequence/ServiceLinkInJourneyPattern/ServiceLinkRef/@ref |
