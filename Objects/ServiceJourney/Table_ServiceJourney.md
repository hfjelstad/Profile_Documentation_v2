...
| Name | xsd:string | 0..1 | 0..1 | 0..1 | Human‑readable name of the journey | Name |
| PrivateCode | xsd:normalizedString | 0..1 | 0..1 | 0..1 | Internal non‑public code (e.g., trip or train number) | PrivateCode |
| Description | xsd:string | 0..1 | 0..1 |  | Free‑text description | Description |
| TransportMode | TransportModeEnumeration | 0..1 | 0..1 |  | Public transport mode (e.g., bus, rail) | TransportMode |
| BusSubmode | BusSubmodeEnumeration | 0..1 | 0..1 |  | Submode for bus services | TransportSubmode/BusSubmode |
...
| DepartureTime | xsd:time | 0..1 | 0..1 | 0..1 | Planned departure time from the stop | passingTimes/TimetabledPassingTime/DepartureTime |
| ArrivalDayOffset | xsd:integer | 0..1 | 0..1 |  | Offset applied to ArrivalTime (e.g., +1 next day) | passingTimes/TimetabledPassingTime/ArrivalDayOffset |
