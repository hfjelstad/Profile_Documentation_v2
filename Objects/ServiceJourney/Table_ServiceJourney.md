...
| [JourneyPatternRef](../JourneyPattern/Table_JourneyPattern.md) | VersionedRef | 1..1 |  |  | Reference to the JourneyPattern defining the stop sequence | JourneyPatternRef/@ref |
| ../Line/Table_Line.md | VersionedRef | 0..1 |  |  | Reference to the served Line | LineRef/@ref |
| [FlexibleLineRef](../FlexibleLine/Table_FlexibleLine.md) | VersionedRef | 0..1 |  |  | Reference to a FlexibleLine (on‑demand services) | FlexibleLineRef/@ref |
| ../Operator/Table_Operator.md | VersionedRef | 0..1 |  |  | Reference to an Operator | OperatorRef/@ref |
| ../DayType/Table_DayType.md | VersionedRef | 0..* |  |  | DayType(s) on which the journey operates | dayTypes/DayTypeRef/@ref |
...
| [StopPointInJourneyPatternRef](../JourneyPattern/Table_JourneyPattern.md) | VersionedRef | 1..1 |  |  | Reference to a StopPointInJourneyPattern | passingTimes/TimetabledPassingTime/StopPointInJourneyPatternRef/@ref |
...
| BlockRef | VersionedRef | 0..1 |  |  | Reference to a Block or TrainBlock (vehicle working) | BlockRef/@ref |
